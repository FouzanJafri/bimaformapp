...
class DoctorandDiagnosisDetails(models.Model):
    ...
    doctor_inCaseOfAccident=models.BooleanField(default=False)
    doctor_reportedToPolice=models.BooleanField(default=False)
    doctor_injuryorDiseaseCausedDueToSubstance=models.BooleanField(default=False)
    doctor_testAlcohol=models.BooleanField(default=False)
